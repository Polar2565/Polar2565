...
| **Ghost Prism + [Atenea](https://github.com/Rzztr/AteneaV3-1)** | Collaborative safety system developed for CodeCup 2026: Atenea captures emergency alerts and geolocation from a mobile PWA, while [GhostPrism](https://github.com/Rzztr/GhostPrism) provides the operations dashboard, live map, incident history, and resolution workflow. My Git contributions in Atenea include the `version-pro` interface, real-time flow, PWA/offline support, and its merge into `main`. |
...
| **2026** | [**CodeCup 2026**](https://codecup2026.com/) · Guadalajara | Selected for the advanced phase as **one of four teams in the Safety & Wellbeing track**—part of a 12-team advanced cohort across three tracks. Our collaborative solution combined [**Atenea**](https://github.com/Rzztr/AteneaV3-1), the mobile emergency-alert PWA, with [**Ghost Prism**](https://github.com/Rzztr/GhostPrism), the real-time operations console. The system addressed attendee safety for large-scale events in the context of Guadalajara as a 2026 World Cup host city. The event brought together UAG, the U.S. Consulate General in Guadalajara, Improving, the Government of Zapopan, and innovation partners. |

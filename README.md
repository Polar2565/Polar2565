...
| [**ClandBus · Acumatica API Technical Assessment**](https://github.com/Polar2565/clandbus-erp-integration-dashboard) | Full-stack proof of concept built to explore Acumatica's REST API and turn sales-order data into an operational dashboard. It demonstrates Angular, ASP.NET Core, ERP authentication, session cookies, filtering, updates, and action execution. It is a technical assessment—not a production deployment. |
| [**Atenea**](https://github.com/Rzztr/AteneaV3-1) | Mobile-first emergency-alert PWA. It captures the best available device location, submits an incident, continues location tracking, and stores pending alerts in IndexedDB when the network is unavailable. My Git contributions include the `version-pro` interface, real-time workflow, PWA/offline support, and its merge into `main`. |
| [**Ghost Prism**](https://github.com/Rzztr/GhostPrism) | Separate operator-facing PWA for receiving and managing incidents. It provides authenticated access, operational metrics, active-alert monitoring, a Leaflet live map, incident history, resolution actions, and Supabase synchronization. This repository is maintained by a project collaborator. |
| [**SOL RUNNER**](https://github.com/Polar2565/SOL-RUNNER) | Browser-based roguelite arena using Canvas, Express, Phantom Wallet, and transactions on Solana Devnet. Reached the **Top 10** in an international, Latin America-wide Solana selection process and was selected for incubation after passing the interview and business-viability review. **Current status:** development paused. |
...
These were not open-attendance events. Several required application screening, technical training, examinations, interviews, or jury review before reaching a national, international, or in-person stage.
...
| **2026** | **Solana LATAM Hackathon** · International / Latin America | **SOL RUNNER** reached the **Top 10** in an international selection spanning Latin America. From a 50-project cohort, it passed both the interview and business-viability review and was **selected for the project incubator**. Development is currently paused, but the international selection and validation milestones were completed. |
| **2026** | [**CodeCup 2026**](https://codecup2026.com/) · Guadalajara | Selected for the advanced phase as **one of four teams in the Safety & Wellbeing track**—part of a 12-team advanced cohort across three tracks. We developed two distinct applications that worked together: [**Atenea**](https://github.com/Rzztr/AteneaV3-1) generated emergency reports and location updates from the attendee's device, while [**Ghost Prism**](https://github.com/Rzztr/GhostPrism) received, mapped, monitored, and resolved those incidents from the operator side. They shared the competition prototype's Supabase data flow but remain separate repositories and applications. The event brought together UAG, the U.S. Consulate General in Guadalajara, Improving, the Government of Zapopan, and innovation partners in the context of Guadalajara as a 2026 World Cup host city. |
...
| **2025** | [**Interledger Hackathon**](https://interledger.org/summit/hackathon) · International final in Mexico City | Qualified for the in-person event after completing Open Payments training and passing the required assessment. Built **Chambitas**, a community-services marketplace using Open Payments, during the **24-hour international final**, which brought together more than **170 participants and 47 teams**, including participants who traveled from different Mexican states and other countries. |
| **2024** | **Cybersecurity Hackathon · Instituto Tecnológico de Aguascalientes (ITA)** | Earned **2nd place as a team** in the cybersecurity challenge. |
...
- Practical experience with **Open Payments and Interledger** through an international, in-person hackathon in Mexico City · 2025.
...
- **Ingeniería en Desarrollo y Gestión de Software** · Universidad Tecnológica de Aguascalientes · January 2025 – August 2026 · **Academic program completed; degree and professional-license issuance in progress.**
